...
export const METRICS: Metric[] = [
  ...
  { value: String(PRODUCTION_SYSTEMS_COUNT), numericValue: PRODUCTION_SYSTEMS_COUNT, label: 'Production Gen AI Systems', context: 'PAR Drafting Assistant, CFO Analytics Engine, Benchmarking Engine (v1 → v2 refactor)' },
  { value: '40K+', numericValue: 40, suffix: 'K+', label: 'Transits Analyzed', context: 'CFO Analytics Engine — on-the-fly millisecond slicing' },
  { value: '2wk', numericValue: 2, suffix: 'wk', label: 'Fastest Refactor', context: 'Benchmarking Engine v1 → v2 concurrent sprint' },
