...
export const METRICS: Metric[] = [
  ...
  { value: String(PRODUCTION_SYSTEMS_COUNT), numericValue: PRODUCTION_SYSTEMS_COUNT, label: 'Production Gen AI Systems', context: 'FundingRequest, WorkforceAnalytics, FinancialBenchmarking (v1 → v2 refactor)' },
