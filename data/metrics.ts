...
export const METRICS: Metric[] = [
  ...
  { value: String(PRODUCTION_SYSTEMS_COUNT), numericValue: PRODUCTION_SYSTEMS_COUNT, label: 'Production AI Systems', context: 'AI/LLM Drafting Platform, WorkforceAnalytics, FinancialBenchmarking v1 & v2' },
