...
export const SKILLS: Skill[] = [
  ...
  { name: 'Field-group RAG (two-stage retrieval)', category: 'genai', firstShipped: 2024, anchorProject: 'External Data Service automation → PAR Assist', anchorLink: '/projects/par-assist' },
