...
const PROJECTS_CHRONOLOGICAL: Project[] = [
  ...
  // Arc 4: Intelligent Systems (2024-present)
  {
    ...
    caption:
      'Canadian Big 6 bank peer-benchmarking engine. v1 (Sr DS, solo): built end-to-end to automate extraction and matching despite quarterly Supplementary Financial Package schema shifts, breaking the long-standing peer-analysis bottleneck. v2 (Lead, 2-week concurrent refactor sprint, run in parallel with WorkforceAnalytics and the Amplify intern program): refactored the v1 benchmarking module into multi-stage RAG with multi-gate query parsing across bank, parameter, platform, and time-period, plus a text-to-SQL layer over rich KPI metadata and embeddings. My direct report and the broader team integrated and productionalized it as FinancialBenchmarking v2. CFO One RBC Team Award (2025) for v1.',
    description:
