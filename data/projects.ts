...
export const PROJECTS: Project[] = [
  ...
  // Arc 4: Intelligent Systems (2024-present)
  {
    ...
    heroMetric: { value: FINANCIAL_BENCHMARKING_V2_BUILD_TIME, label: 'Concept → Production' },
    caption:
      'AI-native benchmarking engine for CFO Group. Natural language to validated SQL via intent parsing, KPI disambiguation, and embeddings. v1 benchmarked Big 6 banks; v2 shipped in two weeks while running WorkforceAnalytics + Amplify.',
    description:
