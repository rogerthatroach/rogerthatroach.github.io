...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: 'FinancialBenchmarking Benchmarking Engine',
    ...
    description:
      'Strategic benchmarking engine that translates natural language into validated, schema-aware SQL. v2 designed and shipped in two weeks while concurrently advancing WorkforceAnalytics and the Amplify internship program.',
    highlights: [
