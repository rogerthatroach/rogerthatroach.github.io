import {
  ...
  WORKFORCE_ANALYTICS_FACTORIAL_COMBINATIONS,
  PAR_ASSIST_SCALE,
} from './canonical';
...
const PROJECTS_CHRONOLOGICAL: Project[] = [
  ...
  },
  {
    ...
    heroMetric: { value: WORKFORCE_ANALYTICS_FACTORIAL_COMBINATIONS, label: 'Factorial Combinations' },
    caption:
    ...
    highlights: [
      'Two-wall architecture: approved foundation model handles parse / route / metadata extraction / synthesis; deterministic Cython-compiled Python handles entitlement + compute. LLM never sees operational data.',
