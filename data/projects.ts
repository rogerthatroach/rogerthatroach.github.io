...
const PROJECTS_CHRONOLOGICAL: Project[] = [
  ...
  // Arc 4: Intelligent Systems (2024-present)
  {
    ...
    heroMetric: { value: FINANCIAL_BENCHMARKING_V2_BUILD_TIME, label: 'v1 → v2 refactor' },
    caption:
      'AI-native benchmarking engine for CFO Group. Natural language to validated SQL via intent parsing, KPI disambiguation, and embeddings. v1 benchmarked Big 6 banks; v2 refactored in a concurrent 2-week sprint alongside WorkforceAnalytics productionization and the Amplify program.',
    description:
  ...
  },
  {
    ...
    stack: ['approved foundation model', 'Custom Python router', 'Cython compute', 'Postgres', 'EPM entitlement'],
