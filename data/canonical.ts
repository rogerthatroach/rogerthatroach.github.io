 ...
 *
 *   1. PAR Drafting Assistant     (formerly AI/LLM Drafting Platform) — pilot launched April 2026; enterprise rollout in progress
 *   2. CFO Analytics Engine       (formerly WorkforceAnalytics)   — production since Nov 2025
 *   3. Benchmarking Engine        (formerly FinancialBenchmarking)      — v1 shipped, v2 is a concurrent 2-week refactor of v1 (one product, two revisions)
 *
 ...
 *
 * Formerly: "FinancialBenchmarking v2 build time".
 */
...
export const FINANCIAL_BENCHMARKING_V2_BUILD_TIME = BENCHMARKING_V2_BUILD_TIME;
...
export const WORKFORCE_ANALYTICS_FACTORIAL_COMBINATIONS = CFO_ANALYTICS_FACTORIAL_COMBINATIONS;
...
export const WORKFORCE_ANALYTICS_ROLLUPS = CFO_ANALYTICS_ROLLUPS;
...
export const WORKFORCE_ANALYTICS_GEOGRAPHIES = CFO_ANALYTICS_GEOGRAPHIES;
