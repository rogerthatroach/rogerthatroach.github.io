 ...
 *   3. FinancialBenchmarking       — v1 shipped, v2 is a concurrent refactor of v1 (one product, two revisions)
 *
 * Per 2026-04-21 audit: do NOT present FinancialBenchmarking v2 as an independent 4th product.
...
/**
 * FinancialBenchmarking v2 refactor sprint length. NOT an independent concept-to-production
...
/** Transits: leaf-level routing / cost-centre units in WorkforceAnalytics. */
