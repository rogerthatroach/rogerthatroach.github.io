import { AgenticArchitecture, SubAgentExecution, EPMTranslation, FullSystemArchitecture, EventModelAnimation } from "@/components/blog/BlogDiagrams"
...
The computation layer consists of <InlineEquation html={tex("k")} /> specialized sub-agents <InlineEquation html={tex("\\{A_1, A_2, \\ldots, A_k\\}")} />, each handling a partition of the domain class space:
