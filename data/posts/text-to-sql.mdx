import { FiveStagePipeline, EmbeddingSpace, GuardrailValidator, FullPipelineFlow } from "@/components/blog/BlogDiagrams"
...
1. **Whitelist check:** Parse the generated SQL AST and verify all table and column references against <InlineEquation html={tex("T_{\\text{allowed}}")} /> and <InlineEquation html={tex("C_{\\text{allowed}}")} />
...
**Factor 3: Framework standardization.** The codebase was built within
