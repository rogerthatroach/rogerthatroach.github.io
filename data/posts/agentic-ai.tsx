...
export default function AgenticAIPost() {
  return (
    <>
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">2. Problem Formulation</h2>

      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">2.1 System Requirements</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">2.2 Why Monolithic LLM Architectures Fail</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">3. Architecture: LLM-as-Router</h2>

      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">3.1 Formal Definition</h3>
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">3.2 Intent Space</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">3.3 Sub-Agent Orchestration</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">4. Data Confidentiality Guarantee</h2>

      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">4.1 Threat Model</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">4.2 Boundary Enforcement</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">5. Entitlement Model: EPM-to-SQL Translation</h2>

      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">5.1 The Translation Problem</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">5.2 Formal Model</h3>
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">5.3 The Translation Pipeline</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">6. Event-Driven Data Model</h2>

      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">6.1 Events vs. Snapshots</h3>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <h3 className="mb-3 mt-8 text-lg font-medium text-text-primary">6.2 Automatic Reconciliation</h3>
      ...
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">7. Production Validation</h2>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* 8. Related Work                                                  */}
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">8. Related Work</h2>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      {/* 9. Conclusion                                                    */}
      {/* ================================================================ */}
      <h2 className="mb-4 mt-12 text-xl font-semibold text-text-primary">9. Conclusion</h2>
      <p className="mb-4 text-sm leading-relaxed text-text-secondary">
      ...
      <ol className="mb-4 list-inside list-decimal space-y-2 text-sm text-text-secondary">
        <li>
          Zhao, W.X., et al. &ldquo;A Survey of Large Language Models.&rdquo;{' '}
          <em>arXiv preprint arXiv:2303.18223</em> (2023).
        </li>
        <li>
          Sun, Z., et al. &ldquo;TrustLLM: Trustworthiness in Large Language Models.&rdquo;{' '}
          <em>arXiv preprint arXiv:2401.05561</em> (2024).
        </li>
        <li>
          Ouyang, S., et al. &ldquo;LLM is Like a Box of Chocolates: the Non-determinism of
          ChatGPT in Code Generation.&rdquo;{' '}
          <em>arXiv preprint arXiv:2308.02828</em> (2023).
        </li>
        <li>
          Li, H., et al. &ldquo;Privacy in Large Language Models: Attacks, Defenses and Future
          Directions.&rdquo; <em>arXiv preprint arXiv:2310.10383</em> (2023).
        </li>
        <li>
          Yao, S., et al. &ldquo;ReAct: Synergizing Reasoning and Acting in Language
          Models.&rdquo; <em>ICLR 2023</em>.
        </li>
        <li>
          Schick, T., et al. &ldquo;Toolformer: Language Models Can Teach Themselves to Use
          Tools.&rdquo; <em>NeurIPS 2023</em>.
        </li>
        <li>
          Rebedea, T., et al. &ldquo;NeMo Guardrails: A Toolkit for Controllable and Safe LLM
          Applications.&rdquo; <em>EMNLP 2023 (Demo)</em>.
        </li>
        <li>
          Pourreza, M. and Rafiei, D. &ldquo;DIN-SQL: Decomposed In-Context Learning of
          Text-to-SQL with Self-Correction.&rdquo; <em>NeurIPS 2023</em>.
        </li>
        <li>
          Gao, D., et al. &ldquo;Text-to-SQL Empowered by Large Language Models: A Benchmark
          Evaluation.&rdquo; <em>VLDB 2024</em>.
        </li>
        <li>
          LangGraph Documentation. LangChain, Inc.{' '}
          <em>https://langchain-ai.github.io/langgraph/</em>
        </li>
        <li>
      ...
      <ul className="mb-4 list-inside list-disc space-y-2 text-sm text-text-secondary">
        <li>
          Chase, H. &ldquo;LangChain: Building Applications with LLMs through
          Composability.&rdquo; (2022).{' '}
          <em>https://github.com/langchain-ai/langchain</em>
        </li>
        <li>
          Anthropic. &ldquo;Model Context Protocol (MCP) Specification.&rdquo; (2024).{' '}
          <em>https://modelcontextprotocol.io</em>
        </li>
        <li>
          Microsoft. &ldquo;Responsible AI Principles.&rdquo;{' '}
          <em>https://www.microsoft.com/en-us/ai/responsible-ai</em>
        </li>
        <li>
          Google. &ldquo;Secure AI Framework (SAIF).&rdquo; (2023).{' '}
          <em>https://safety.google/cybersecurity-advancements/saif/</em>
        </li>
      </ul>
    </>
  );
