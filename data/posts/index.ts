...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    meta: {
      ...
      title: 'How We Built FundingRequest: From Intern POC to Bank-Wide Product',
  ...
  },
  {
    meta: {
      ...
      readingTime: '6 min read',
      abstract:
        'The story of automating RBC\u2019s Commodity Tax return process from months to 90 minutes \u2014 and why the real deliverable wasn\u2019t the automation but the stakeholder trust it built. Covers the architectural decision to treat Tableau as a transparency layer (not just an output), the stakeholder dynamics of automating institutional knowledge, and the cascade of AI initiatives this first project underwrote: FinancialBenchmarking v1, FinancialBenchmarking v2, WorkforceAnalytics, FundingRequest.',
      status: 'draft',
      projectId: 'commodity-tax',
      register: 'builder',
    },
