...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    meta: {
      ...
      subtitle:
        'The same AI/LLM Drafting Platform system, rewritten in practitioner register via the writing rewrite framework. Decisions + options considered + constraints as first-class structure; the formal math moves to an optional appendix.',
      date: '2026-04-22',
