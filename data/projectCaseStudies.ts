...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    tldr: {
      ...
      decision:
        'Two-wall architecture. approved foundation model handles gate / metadata extraction / answer / synthesis only — never touches operational data. Between the walls, Cython-compiled Python runs event-level ins-outs math in milliseconds over ~40K leaf-level cost centres, with the permission-to-SQL entitlement cascade applied before compute. Simple queries take one Answer call; cross-domain queries fan out to 3 parallel Answer-stage calls (Headcount / HR Costs / Open Positions) plus a final synthesis.',
      impact:
