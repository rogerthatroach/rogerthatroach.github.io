...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    tldr: {
      ...
      impact:
        'Shipped to production in 2 weeks — while simultaneously running WorkforceAnalytics development and the summer intern program. 2025 CFO One RBC Team Award.',
    },
    sections: {
      context:
