...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    tldr: {
      ...
      decision:
        'Two-wall architecture. GPT-4.1 handles parse / route / metadata extraction / synthesis only — never touches operational data. Between the walls, Cython-compiled Python runs event-level ins-outs math in milliseconds over ~40K leaf-level cost centres, with the permission-to-SQL entitlement cascade applied before compute. In-scope answers either go straight to a single synthesis call or fan out to up to 3 parallel final subagents (entitlement / Headcount / Open Positions) before combining.',
      impact:
