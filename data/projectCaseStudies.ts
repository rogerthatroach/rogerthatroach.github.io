...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    sequencing:
      'Commodity Tax was the cascade origin. When I joined the CFO Group in 2022, nobody had asked me to build AI — I was hired to automate a tax process. Delivering that in under a year, with dashboards the CFO could audit, earned the credibility to propose Benchmarking Engine v1 (Big 6 bank benchmarking, 2024), then Benchmarking Engine v2 (AI-native rewrite, 2 weeks, 2024), then CFO Analytics Engine (production 2025), then conceive PAR Drafting Assistant from an intern POC (shipped April 2026). Each project underwrote the next one\'s scope. The Commodity Tax wasn\'t about tax — it was about proving I could deliver production systems in regulated finance before asking for license to build something ambitious.',
    blogPostSlug: 'commodity-tax-cfo-trust',
    leadershipCallout:
      'This was my first project at RBC — and I treated it as an audition. By choosing Tableau as the transparency layer (not just an output), I gave skeptical finance stakeholders visibility into every step of the automation. The resulting trust didn\'t just deliver Commodity Tax — it opened the door for Benchmarking Engine, CFO Analytics Engine, and every AI initiative that followed. The months-to-90-minutes metric became the team\'s calling card with CFO leadership.',
    sections: {
      context:
  ...
  },
  {
    ...
    tldr: {
      ...
      impact:
        'Shipped to production in 2 weeks — while simultaneously running CFO Analytics Engine development and the summer intern program. 2025 CFO One RBC Team Award.',
    },
    sections: {
      context:
        'RBC\'s CFO Group needed to benchmark financial KPIs against the Big 6 Canadian banks using Supplementary Financial Packages — publicly available but complex financial disclosures. Benchmarking Engine v1 was a rules-based benchmarking engine I\'d built and productionized earlier. v2 was the AI-native evolution: natural language queries to validated SQL, with embeddings-based KPI disambiguation.',
      myRole:
        'Sole designer and builder of Benchmarking Engine v2. I designed the five-stage pipeline architecture, implemented it, and shipped it to production — all within two weeks, while simultaneously leading CFO Analytics Engine development and the summer intern program. This was a deliberate sprint: months of research and brainstorming crystallized into two weeks of focused execution.',
      stakeholders:
      ...
      optionsConsidered: [
        {
          option: 'Extend Benchmarking Engine v1 with LLM layer on top',
