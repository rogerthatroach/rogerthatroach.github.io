export const ABOUT = {
  ...
  beliefs: [
    ...
    },
    {
      ...
      body: "AI/LLM Drafting Platform is RBC's first bank-wide production agentic AI platform, conceived as my vision, given to Amplify interns as an ideation exercise to explore the problem space, then built end-to-end. WorkforceAnalytics followed the same arc: conceived, architected, and built end-to-end into a production analytics platform that brought headcount-movement queries from days (line-of-business level only) to real time at any granularity across CFO Group data. The work that matters is the arc from a one-page plan to a system shipping to real users; architecture diagrams without production builds are powerpoint.",
    },
    {
