export const ABOUT = {
  ...
  beliefs: [
    ...
    },
    {
      ...
      body: "AI/LLM Drafting Platform started as an intern's proof-of-concept during the Amplify program. I saw it could scale from a one-team prototype to a bank-wide platform, resourced it, and led the productionization. Today it's the pilot for the bank's first true agentic AI deployment. My job as a leader isn't to have the best ideas. It's to recognize them, clear the path to production, and make sure everyone knows where they started.",
    },
    {
      lead: 'Third, trust beats accuracy in regulated AI.',
      body: "The hardest thing in production AI at a regulated institution isn\u2019t getting the answer right \u2014 it\u2019s getting the humans who own the decision to trust the system that produced it. Commodity Tax\u2019s Tableau transparency layer, WorkforceAnalytics\u2019s EPM entitlement modeling, AI/LLM Drafting Platform\u2019s MCP-tool audit trail: at every stage the architecture has to survive stakeholder audit. That\u2019s the job.",
    },
  ],
  closer:
