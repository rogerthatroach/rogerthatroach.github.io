export const ABOUT = {
  ...
  beliefs: [
    ...
    },
    {
      ...
      body: "AI/LLM Drafting Platform started as an intern's proof-of-concept during the Amplify program. I saw the shape of something bigger, resourced it, and scaled the vision. Today it's shipping as a bank-wide agentic AI platform. My job as a leader isn't to have the best ideas. It's to recognize them, clear the path to production, and make sure everyone knows where they started.",
    },
    {
