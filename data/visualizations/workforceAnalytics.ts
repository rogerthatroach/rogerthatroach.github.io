...
export interface WorkforceAnalyticsFigureBase {
  id: string;
  title: string;
  thesis: string;
  caption: string;
...
export interface WorkforceAnalyticsScenarioStage {
...
export interface WorkforceAnalyticsOverviewScenario {
  id: 'simple' | 'cross-domain';
  label: string;
  summary: string;
  stages: readonly [WorkforceAnalyticsScenarioStage, WorkforceAnalyticsScenarioStage, WorkforceAnalyticsScenarioStage];
}

export interface WorkforceAnalyticsCaseOverviewContent extends WorkforceAnalyticsFigureBase {
  ...
  scenarios: readonly WorkforceAnalyticsOverviewScenario[];
}

export interface WorkforceAnalyticsContrastPath {
  label: string;
  title: string;
  summary: string;
...
export interface WorkforceAnalyticsBuilderContrastContent extends WorkforceAnalyticsFigureBase {
  paths: readonly [WorkforceAnalyticsContrastPath, WorkforceAnalyticsContrastPath];
  chosenLabel: string;
  decisionLabel: string;
  decisionDetail: string;
}

export interface WorkforceAnalyticsEntitlementStep {
  number: string;
  title: string;
  detail: string;
  failure: string;
...
export interface WorkforceAnalyticsDecision {
  number: string;
  pressure: string;
  choice: string;
  retainedResponsibility: string;
  entitlementDetail?: readonly WorkforceAnalyticsEntitlementStep[];
}

export interface WorkforceAnalyticsDecisionMapContent extends WorkforceAnalyticsFigureBase {
  columnLabels: readonly [string, string, string];
  decisions: readonly WorkforceAnalyticsDecision[];
  detailLabel: string;
  failureLabel: string;
...
export interface WorkforceAnalyticsResponsibility {
  name: string;
...
export interface WorkforceAnalyticsTechnicalOverviewContent extends WorkforceAnalyticsFigureBase {
  columnLabels: readonly [string, string, string, string];
  outputLabel: string;
  responsibilities: readonly WorkforceAnalyticsResponsibility[];
  humanRuleLabel: string;
  humanRuleDetail: string;
}

export interface WorkforceAnalyticsPermissionStage {
  number: string;
  title: string;
  receives: string;
  records: string;
...
export interface WorkforceAnalyticsPermissionCascadeContent extends WorkforceAnalyticsFigureBase {
  handoffLabels: readonly [string, string, string];
  stages: readonly WorkforceAnalyticsPermissionStage[];
  failClosedLabel: string;
  failClosedDetail: string;
}

export interface WorkforceAnalyticsMovementScenario {
...
export interface WorkforceAnalyticsMovementModelContent extends WorkforceAnalyticsFigureBase {
  scenarioControlLabel: string;
  columnLabels: readonly [string, string, string, string];
  scenarios: readonly WorkforceAnalyticsMovementScenario[];
}
...
const ENTITLEMENT_DETAIL: readonly WorkforceAnalyticsEntitlementStep[] = [
  {
    number: '01',
...
[
  ...
  WORKFORCE_ANALYTICS_BUILDER_CONTRAST,
