...
export const TIMELINE: TimelineNode[] = [
  {
    ...
    description:
      'Architecting enterprise agentic AI. Conceived AI/LLM Drafting Platform (pilot April 2026; enterprise rollout in progress). Productionized WorkforceAnalytics. Refactored FinancialBenchmarking v1 → v2 in a concurrent 2-week sprint. Led 2025 Amplify intern program. ~70% hands-on.',
    ...
    projects: [
      ...
      },
      {
        ...
        decisionRationale:
          'Deterministic agents + GPT for intent routing only — regulated finance cannot tolerate LLM hallucination on numbers. Refactored monolith → 3 parallel sub-agents (EPM / Headcount / Open Positions) because approved foundation model context limits made a single agent infeasible.',
