...
export const TIMELINE: TimelineNode[] = [
  {
    ...
    description:
      'Architecting enterprise agentic AI. Conceived FundingRequest (pilot April 2026; enterprise rollout in progress). Productionized WorkforceAnalytics. Refactored FinancialBenchmarking v1 → v2 in a concurrent 2-week sprint. Led the 2025 summer intern cohort. ~70% hands-on.',
    ...
    transitionStory:
      'Promoted internally from Senior Data Scientist after 2.5 years — Commodity Tax (months → 90 min), FinancialBenchmarking v1 productionization, WorkforceAnalytics groundwork. The Lead role added product vision (not just execution), cross-functional leadership of engineering services partners, expanded hiring involvement, and ownership of net-new enterprise platforms (FundingRequest originated post-promotion via the summer intern program).',
    teamContext:
      'Current team: 1 Senior AI Scientist direct + 2 interns joining May 2026 (3 total). Cumulative intern scope: 7 managed end-to-end (the 2025 summer intern cohort led the conversion of an intern POC → bank-wide product). Cross-functional leadership of engineering services partners (senior + junior) on WorkforceAnalytics. Contributing to hiring decisions since 2023 (university recruiting, screening, performance reviews). Peak simultaneous management: 5.',
    projects: [
      {
        name: 'FundingRequest',
        oneLiner:
      ...
      },
      {
        ...
        oneLiner:
          'Concurrent 2-week refactor of FinancialBenchmarking v1 into a text-to-SQL-first architecture with KPI disambiguation and guardrails.',
        decisionRationale:
  ...
  },
  {
    ...
    description:
      'Overhauled the Commodity Tax process (months → 90 min). Productionized FinancialBenchmarking v1. Built the data foundations for WorkforceAnalytics. Earned trust with CFO stakeholders.',
