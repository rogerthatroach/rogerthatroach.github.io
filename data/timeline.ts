...
export const TIMELINE: TimelineNode[] = [
  {
    ...
    description:
      'Architecting enterprise agentic AI systems. Conceived AI/LLM Drafting Platform, shipped WorkforceAnalytics, built FinancialBenchmarking v2 in two weeks, leading the Amplify intern program. 70% hands-on.',
