 ...
 *
 * FundingRequest is the test subject because it's the flagship (LangGraph +
  ...
  nodes: [
    {
      ...
      data: {
        label: 'Author',
        description: 'The human drafting the PAR (project funding request).',
        icon: '👤',
        category: 'user',
