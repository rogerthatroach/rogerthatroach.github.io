...
/**
 * FinancialBenchmarking architecture — "The Pipeline + Two Walls" diagram.
 *
 ...
 *
 * Visual register matches WorkforceAnalytics's cascade: same canvas dimensions,
...
// ── Palette (mirrors WorkforceAnalytics for register continuity) ───────────────
...
// ── Layout ───────────────────────────────────────────────────────────
// Canvas ~880w × ~1020h — near-square portrait, matches WorkforceAnalytics.
...
export default function FinancialBenchmarkingCascade() {
  ...
  return (
    <div
      ...
      role="group"
      aria-label="FinancialBenchmarking natural-language query pipeline"
    >
      ...
      <SemanticDiagramFallback
        title="FinancialBenchmarking query pipeline"
