 ...
 *
 * Visual register: same canvas + palette family as the WorkforceAnalytics/FinancialBenchmarking
...
// diagram (matches the Postgres rail in WorkforceAnalytics + FinancialBenchmarking).
