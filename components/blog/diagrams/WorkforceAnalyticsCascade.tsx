...
/**
 * WorkforceAnalytics architecture — "The Cascade" diagram.
 *
...
const initialNodes: Node[] = [
  ...
  // Parse + Route — row 1 of 2 (sequential flow control)
  {
    ...
    data: { badge: 'LLM 1', label: 'Parse intent', sub: 'approved foundation model', color: LLM, size: 'sm' } satisfies PillNodeData,
    draggable: false,
  },
  {
    id: 'route',
...
export default function WorkforceAnalyticsCascade() {
