...
import type { FinancialBenchmarkingMilestoneContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingMilestoneFigure({ content }: { content: FinancialBenchmarkingMilestoneContent }) {
