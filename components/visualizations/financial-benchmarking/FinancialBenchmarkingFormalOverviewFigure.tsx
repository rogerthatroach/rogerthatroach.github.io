...
import type { FinancialBenchmarkingFormalOverviewContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingFormalOverviewFigure({ content }: { content: FinancialBenchmarkingFormalOverviewContent }) {
