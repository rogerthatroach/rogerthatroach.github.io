...
import type { FinancialBenchmarkingCandidateAmbiguityContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingCandidateAmbiguityFigure({ content }: { content: FinancialBenchmarkingCandidateAmbiguityContent }) {
