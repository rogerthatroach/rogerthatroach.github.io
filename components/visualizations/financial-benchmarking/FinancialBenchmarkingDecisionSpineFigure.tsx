...
import type { FinancialBenchmarkingDecisionSpineContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingDecisionSpineFigure({ content }: { content: FinancialBenchmarkingDecisionSpineContent }) {
