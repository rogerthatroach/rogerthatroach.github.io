...
import type { FinancialBenchmarkingValidatorContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingValidatorFigure({ content }: { content: FinancialBenchmarkingValidatorContent }) {
