...
import type { FinancialBenchmarkingExecutionTraceContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingExecutionTraceFigure({ content }: { content: FinancialBenchmarkingExecutionTraceContent }) {
