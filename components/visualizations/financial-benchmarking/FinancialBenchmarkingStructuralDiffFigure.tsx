...
import type { FinancialBenchmarkingStructuralDiffContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingStructuralDiffFigure({ content }: { content: FinancialBenchmarkingStructuralDiffContent }) {
