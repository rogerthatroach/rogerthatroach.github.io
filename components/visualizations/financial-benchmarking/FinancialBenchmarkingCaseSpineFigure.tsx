...
import type { FinancialBenchmarkingCaseSpineContent } from '@/data/visualizations/financialBenchmarking';

export default function FinancialBenchmarkingCaseSpineFigure({ content }: { content: FinancialBenchmarkingCaseSpineContent }) {
