import type { WorkforceAnalyticsBuilderContrastContent } from '@/data/visualizations/workforceAnalytics';
import FigureHeader from '@/components/visualizations/FigureHeader';

interface WorkforceAnalyticsBuilderContrastFigureProps {
  content: WorkforceAnalyticsBuilderContrastContent;
}

export default function WorkforceAnalyticsBuilderContrastFigure({ content }: WorkforceAnalyticsBuilderContrastFigureProps) {
