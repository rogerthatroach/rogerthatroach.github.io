...
import type {
  WorkforceAnalyticsMovementModelContent,
  WorkforceAnalyticsMovementScenario as WorkforceAnalyticsMovementScenarioContent,
} from '@/data/visualizations/workforceAnalytics';

interface WorkforceAnalyticsMovementScenarioProps {
...
function ScenarioPanel({
  ...
  content: WorkforceAnalyticsMovementModelContent;
  scenario: WorkforceAnalyticsMovementScenarioContent;
}) {
  const values = [
...
export default function WorkforceAnalyticsMovementScenario({ content }: WorkforceAnalyticsMovementScenarioProps) {
  const [selectedId, setSelectedId] = useState<WorkforceAnalyticsMovementScenarioContent['id']>('within-rollup');
  const panelId = useId();
