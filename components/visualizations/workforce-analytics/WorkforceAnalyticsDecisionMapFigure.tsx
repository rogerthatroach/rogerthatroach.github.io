import type {
  WorkforceAnalyticsDecisionMapContent,
  WorkforceAnalyticsEntitlementStep,
} from '@/data/visualizations/workforceAnalytics';
import FigureHeader from '@/components/visualizations/FigureHeader';

interface WorkforceAnalyticsDecisionMapFigureProps {
  content: WorkforceAnalyticsDecisionMapContent;
}
...
function EntitlementDetail({
  ...
  label: string;
  failureLabel: string;
  steps: readonly WorkforceAnalyticsEntitlementStep[];
}) {
  return (
...
export default function WorkforceAnalyticsDecisionMapFigure({ content }: WorkforceAnalyticsDecisionMapFigureProps) {
