import type { WorkforceAnalyticsTechnicalOverviewContent } from '@/data/visualizations/workforceAnalytics';
import FigureHeader from '@/components/visualizations/FigureHeader';

interface WorkforceAnalyticsTechnicalOverviewFigureProps {
  content: WorkforceAnalyticsTechnicalOverviewContent;
}

export default function WorkforceAnalyticsTechnicalOverviewFigure({ content }: WorkforceAnalyticsTechnicalOverviewFigureProps) {
