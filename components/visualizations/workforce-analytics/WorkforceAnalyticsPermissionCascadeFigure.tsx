import type { WorkforceAnalyticsPermissionCascadeContent } from '@/data/visualizations/workforceAnalytics';
import FigureHeader from '@/components/visualizations/FigureHeader';

interface WorkforceAnalyticsPermissionCascadeFigureProps {
  content: WorkforceAnalyticsPermissionCascadeContent;
}

export default function WorkforceAnalyticsPermissionCascadeFigure({ content }: WorkforceAnalyticsPermissionCascadeFigureProps) {
