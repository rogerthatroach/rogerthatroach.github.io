          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.div
                ...
                className="absolute right-0 top-[calc(100%+0.5rem)] min-w-[12rem] overflow-hidden rounded-xl border border-border-subtle bg-background/85 shadow-2xl backdrop-blur-2xl backdrop-saturate-150 ring-1 ring-inset ring-text-primary/5"
              >
                <ul className="py-1">
                  {NAV_LINKS.map((link) => {
                    const isInternal =
