    ...
    >
      <div className="flex items-center gap-6 px-8 sm:gap-10">
        ...
        >
          ...
          <div className="mx-auto mb-4 flex flex-col items-center gap-1">
            {[0.2, 0.35, 0.5, 0.65, 0.8].map((opacity, i) => (
              <motion.div
                ...
                className="flex h-10 w-14 items-center justify-center rounded border border-red-400/30 bg-red-500/10 dark:border-red-500/30 sm:h-12 sm:w-16"
              >
                <svg width="20" height="20" viewBox="0 0 20 20" className="text-red-600 dark:text-red-400">
          ...
          <span className="font-mono text-xl font-bold text-red-600 dark:text-red-400 sm:text-2xl">Months</span>
        ...
        >
          {/* Clock */}
          <div className="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full border-2 border-green-500/50 bg-green-500/10 shadow-lg shadow-green-500/10 dark:border-green-500/50 sm:h-28 sm:w-28">
            <svg width="48" height="48" viewBox="0 0 48 48" className="text-green-600 dark:text-green-400">
          ...
          <span className="font-mono text-xl font-bold text-green-600 dark:text-green-400 sm:text-2xl">90 min</span>
