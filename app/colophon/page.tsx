  ...
  },
  {
    ...
    value: (
      <>
        ...
        through client-component props). AI/LLM Drafting Platform{' '}
        <a
...
const REFERENCE_IMPLEMENTATIONS: {
...
}[] = [
  {
    ...
    backs: 'FinancialBenchmarking text-to-SQL — formal · builder · practitioner',
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    backs: 'AI/LLM Drafting Platform multi-agent retrieval — three registers',
    status: 'live',
  },
];
