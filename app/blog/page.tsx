 ...
 * project so multi-post projects (PAR Drafting Assistant has 3, Commodity Tax has
 ...
 * first (PAR Drafting Assistant → CFO Analytics Engine → Benchmarking Engine → Commodity Tax → Document
