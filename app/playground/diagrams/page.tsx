...
export const metadata: Metadata = {
  ...
  description:
    'Click-to-drill architecture of AI/LLM Drafting Platform across four abstraction levels: Overview → System → Orchestration → Tool contract. Test bed for the diagrams-within-diagrams pattern before promoting to the formal blog post.',
      ...
      >
        ...
        <div className="mb-10 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm text-text-secondary">
          ...
          <p>
            ...
            agentic blog post. AI/LLM Drafting Platform is the test subject because it has
            the most surface area (LangGraph + MCP + 3 RAG scopes) and a
            working single-level baseline in{' '}
            <code className="font-mono text-xs">components/diagrams/FundingRequestDiagram.tsx</code>.
          </p>
        </div>
        ...
        <h1 className="mb-3 font-display text-3xl font-bold tracking-tight text-text-primary sm:text-4xl">
          AI/LLM Drafting Platform · multi-level
        </h1>
          ...
          <div className="rounded-xl border border-border-subtle bg-surface/30 p-5">
            ...
            <ul className="ml-5 list-disc space-y-2 text-sm text-text-secondary">
              <li>
                ...
                "what does AI/LLM Drafting Platform do?"
              </li>
              <li>
          ...
          <div className="rounded-xl border border-border-subtle bg-surface/30 p-5">
            ...
            <ul className="ml-5 list-disc space-y-2 text-sm text-text-secondary">
              ...
              <li>
                ...
                <code className="font-mono text-xs">FundingRequestDiagram</code> on
        ...
        <div className="mt-10 rounded-xl border border-accent/20 bg-accent-muted/40 p-5 text-sm text-text-secondary">
          ...
          <ul className="ml-5 list-disc space-y-1 text-sm">
            ...
            <li>Apply the multi-level treatment to WorkforceAnalytics (parallel domain extraction stages — cleaner drill shape)</li>
