...
export const metadata: Metadata = {
  ...
  description:
    'Click-to-drill architecture of PAR Assist across four abstraction levels: Overview → System → Orchestration → Tool contract. Test bed for the diagrams-within-diagrams pattern before promoting to the formal blog post.',
      ...
      >
        ...
        <div className="mb-10 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm text-text-secondary">
          ...
          <p>
            ...
            agentic blog post. PAR Assist is the test subject because it has
        ...
        <div className="mt-10 rounded-xl border border-accent/20 bg-accent-muted/40 p-5 text-sm text-text-secondary">
          ...
          <ul className="ml-5 list-disc space-y-1 text-sm">
            ...
            <li>Apply the multi-level treatment to Astraeus (parallel domain extraction stages — cleaner drill shape)</li>
