...
export const metadata: Metadata = {
  ...
  description:
    'Click-to-drill architecture of FundingRequest across four abstraction levels: Overview → System → Orchestration → Tool contract. Test bed for the diagrams-within-diagrams pattern before promoting to the formal blog post.',
      ...
      >
        ...
        <div className="mb-10 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm text-text-secondary">
          ...
          <p>
            ...
            agentic blog post. FundingRequest is the test subject because it has
