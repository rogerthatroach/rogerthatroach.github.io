...
const BULLETS: { heading: string; body: string }[] = [
  {
    heading: 'Shipping',
    body: 'AI/LLM Drafting Platform — the first true agentic framework approved for production at RBC. Pilot live April 2026; enterprise rollout across business lines through Q2/Q3 2026. Single-agent governance envelope, LangGraph on Postgres, two-stage field-group retrieval, N parallel approved foundation model extraction calls. Early design for v2: multi-agent "skills" composed over the v1 substrate.',
  },
  {
    heading: 'Writing',
