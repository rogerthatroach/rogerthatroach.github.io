...
const BULLETS: { heading: string; body: string }[] = [
  {
    heading: 'Shipping',
    body: 'FundingRequest — the first true agentic framework approved for production at RBC. Pilot live April 2026; enterprise rollout across business lines through Q2/Q3 2026. Single-agent governance envelope, LangGraph on Postgres, two-stage field-group retrieval, N parallel approved foundation model extraction calls. Early design for v2: multi-agent "skills" composed over the v1 substrate.',
  },
  {
    heading: 'Writing',
    body: 'Sanitized FundingRequest across every surface (formal math post, practitioner rewrite, builder story, case study, homepage, resume, glossary) in one pass after an audit caught a fabricated three-layer RAG claim sitting unchallenged for weeks. PAR is now the benchmark; applying the same pass to WorkforceAnalytics next.',
  },
  {
    heading: 'Thinking about',
    body: 'How v1 substrates become v2 substrates. The single-agent envelope at FundingRequest was constrained by governance, not by engineering — but the constraint forced a structure (typed MCP tool registry, unified Postgres store, field-group taxonomy) that v2 skills compose on without rewrite. Every envelope you build should make its next envelope cheaper.',
  },
];
