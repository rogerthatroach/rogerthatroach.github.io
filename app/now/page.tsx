...
const BULLETS: { heading: string; body: string }[] = [
  {
    heading: 'Shipping',
    body: 'AI/LLM Drafting Platform — enterprise agentic AI platform at RBC. Pilot launched April 2026; bank-wide rollout through Q2/Q3 2026. WorkforceAnalytics in production since November 2025.',
  },
  {
    heading: 'Writing',
