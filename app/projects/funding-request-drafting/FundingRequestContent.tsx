...
const FundingRequestFlow = dynamic(() => import('@/components/diagrams/FundingRequestFlow'), {
  ssr: false,
  loading: () => (
    <div className="flex h-[700px] w-full items-center justify-center rounded-xl border border-border-subtle bg-surface">
      <span className="text-sm text-zinc-500">Loading architecture diagram...</span>
    </div>
  ),
});
...
export default function FundingRequestContent() {
  return (
    <PageTransition>
        ...
        <div className="mx-auto max-w-content">
          ...
          >
            ...
            <p className="mt-4 max-w-2xl text-lg text-zinc-400">
              Enterprise-wide drafting tool for project funding requests — powered by
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h2 className="text-xl font-bold text-zinc-100">The Story</h2>
            <div className="mt-4 space-y-3 text-sm leading-relaxed text-zinc-400">
              <p>
                AI/LLM Drafting Platform started as an idea from the 2025 Amplify internship program. An
                intern proposed a tool to help with project funding requests — the governance
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h2 className="text-xl font-bold text-zinc-100">Architecture</h2>
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h2 className="text-xl font-bold text-zinc-100">Technical Deep Dive</h2>
          ...
          <motion.div
            ...
            className="mt-16 mb-12 rounded-lg border border-accent/20 bg-accent/5 p-6"
          >
            <p className="text-sm font-medium text-zinc-300">My Role</p>
