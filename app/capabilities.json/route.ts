...
export function GET(): Response {
  ...
  const approachTaxonomy = {
    ...
    dataBoundary:
      'In WorkforceAnalytics the LLM never touches operational data by construction — GPT is used only for gate / metadata extraction / answer / synthesis; deterministic code handles all data access.',
  };
